...
async function getNewsBySubcategory(category, after, count) {
  const data = await fetchAPI(
    `
...
async function getProjectsBySubcategory(category, after, count) {
  const data = await fetchAPI(
    `
...
async function getAboutsBySubcategory(category, after, count) {
  const data = await fetchAPI(
    `
